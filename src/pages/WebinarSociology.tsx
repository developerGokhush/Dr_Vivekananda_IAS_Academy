...
const WebinarSociology = () => {
    const course = optionalClassesCourses.find((c) => c.id === 'sociology') as CourseData;
    ...
    return (
        <Layout>
            <div className="optional-details-page">
                <SEO
                    title="Free Webinar Sociology Dr Vivekananda's IAS Academy"
                    description={`Join our free webinar on Sociology by Dr. Vivekananda's IAS Academy. ${course.subtitle}. Faculty: ${course.faculty}.`}
                    image={course.image}
                />
                    ...
                    <div className="container">
                        <div className="hero-content-wrapper">
                            <div className="details-hero-text">
                                <h1>Free Webinar Sociology Dr Vivekananda's IAS Academy</h1>
...
export default WebinarSociology;
