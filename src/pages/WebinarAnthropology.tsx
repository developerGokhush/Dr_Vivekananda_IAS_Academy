...
const WebinarAnthropology = () => {
    const course = optionalClassesCourses.find((c) => c.id === 'anthropology') as CourseData;
    ...
    return (
        <Layout>
            <div className="optional-details-page">
                <SEO
                    title="Free Webinar Anthropology Dr Vivekananda's IAS Academy"
                    description={`Join our free webinar on Anthropology by Dr. Vivekananda's IAS Academy. ${course.subtitle}. Faculty: ${course.faculty}.`}
                    image={course.image}
                />
...
export default WebinarAnthropology;
