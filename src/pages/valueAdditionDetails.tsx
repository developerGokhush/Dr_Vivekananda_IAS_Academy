...
const ValueAdditionDetails = () => {
  ...
  const course = valueAdditionCourses.find((c) => c.id === id);
  ...
  return (
    <Layout>
      <div className="optional-details-page">
        <SEO
          title={`${course.title} | Value Addition`}
          description={`Enhance your preparation with our ${course.title} value addition course. ${course.subtitle}. Faculty: ${course.faculty}.`}
          image={course.image}
        />
            ...
            <div className="details-sidebar">
              <div className="sidebar-card glass-card">
                ...
                <div className="sidebar-action">
                  ...
                  >
                    {course.fee !== 'To be announced' ? 'Enroll Now' : 'Enquire Now'}
                  </button>
                </div>
              </div>
